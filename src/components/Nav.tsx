...
const Nav = () => {
  ...
  return (
    <header className=" flex p-4">
        ...
        <nav ref={navRef} className="ml-24  md:flex fixed md:static w-[200px]  right-0 top-0">
            <ul className="flex flex-col md:flex-row md:space-x-8 justify-center items-center md:items-start md:justify-start w-full h-full space-y-4 md:space-y-0">
                <li className="md:text-Grayish_Violet md:hover:text-Dark_Violet">Features</li>
                <li className="md:text-Grayish_Violet md:hover:text-Dark_Violet">Pricing</li>
                <li className="md:text-Grayish_Violet md:hover:text-Dark_Violet">Resources</li>
            </ul>
        </nav>
        <div className=" ml-auto hidden md:flex space-x-4">
            <button className="rounded-full px-4 py-2">Login</button>
            <button className=" rounded-full px-4 py-2">Sign Up</button>
        </div>
        <div className=" ml-auto md:hidden z-50 fixed top-0 right-0 flex flex-col h-[15px] justify-between " onClick={handleNav}>
